...
(defconst nusmv-keywords
  '("MODULE" "VAR" "IVAR" "FROZENVAR" "TRANS" "ASSIGN" "INVAR" "DEFINE" "SPEC"
    "LTLSPEC" "INVARSPEC" "FAIRNESS" "JUSTICE" "COMPASSION"
    "process" "array" "of" "case" "esac"
    "next" "init" "INIT" "ISA"
    "in" "union" "COMPUTE" "MAX" "MIN"
    "SYNC" "WEAK" "EVENTS" "CAN_DO" "CONDITION" "EVENT" "FLOW" "der" "URGENT" "global_time_event"
    "MS" "MSC" "EMSC" "NEXT_EVENT_CONDITION" "NAME" "IN" "EVENT_CONDITION")
  "NuSMV keywords.")
...
;; set construct {}, boolean, integer, real
...
(defconst nusmv-declaration-keywords
  '("MODULE" "VAR" "IVAR" "FROZENVAR" "ASSIGN" "TRANS" "INIT" "INVAR" "DEFINE"
